 ...
 * Filename:
 * ---------
 *     gc08a8mipiraw_avatarl5_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A8_SENSOR_ID_BARLEY,
	.module_id = 0x07,
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 3264, 2448, 0, 612, 3264, 1836, 3264, 1836, 0, 0, 3264, 1836, 0, 0, 3264, 1836}, /* video */
...
static kal_uint32 read_gc08a8_version(void)
{
	  kal_uint32 gc08a8_version_value = 0;
	  ...
	  gc08a8_version_value = read_cmos_sensor_m(0x0e);
	  printk("read gc08a8 version 0x0e = %d\n", gc08a8_version_value);
	  return gc08a8_version_value;
}
...
kal_uint16 gc08a8_barley_init_addr_data[] = {
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
	0x0336, 0x70,
...
static kal_uint16 gc08a8_normal_video_addr_data[] = {
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
	0x0336, 0x70,
...
static void sn_get(void)
{
    ...
    Gc08a8_read_region(gi2c.inst[1].pi2c_client,temp_offset_1,p + 8,temp_sn_length);
...
static void sensor_init(void)
{
	...
	table_write_cmos_sensor(gc08a8_barley_init_addr_data,
		sizeof(gc08a8_barley_init_addr_data)/sizeof(kal_uint16));
	pr_debug("[%s] init_End\n", __func__);
}	/*	  sensor_init  */
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc08a8_normal_video_addr_data,
		sizeof(gc08a8_normal_video_addr_data)/sizeof(kal_uint16));
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			pr_debug("[gc08a8_camera_sensor]open:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, sensor_id);
			retry--;
		} while (retry > 0);
		i++;
