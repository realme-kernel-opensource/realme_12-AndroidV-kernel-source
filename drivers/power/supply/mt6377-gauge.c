...
/**
  *mtk patch from ALPS09485498
  *When the battery is low and the charger is plugged in,
  *the battery level is not updated and the vsoc is negatively increasing.
  */
